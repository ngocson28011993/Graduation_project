...
class Zend_Auth_Adapter_OpenId implements Zend_Auth_Adapter_Interface
{
    ...
    /**
     * The response object to perform HTTP or HTML forms redirection
     *
     ...
     *        object to perform HTTP or HTML forms redirection
     * @return void
     */
    ...
    /**
     * Sets an optional response object to perform HTTP or HTML forms redirection
     *
     * @param  string $root
     * @return Zend_Auth_Adapter_OpenId Provides a fluent interface
     */
