...
abstract class Zend_Search_Lucene_Search_Similarity
{
     ...
     * factor for each term in the query and these product are then summed to
     * forms the initial score for a document.
     *
     ...
     * This value is summed for each sloppy phrase match in a document to forms
     ...
     * tf(int) factor for each term in the query and these product are
     * then summed to forms the initial score for a document.
     *
