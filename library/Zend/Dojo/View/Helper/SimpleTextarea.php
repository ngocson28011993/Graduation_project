...
/**
 * dijit.forms.SimpleTextarea view helper
 *
...
class Zend_Dojo_View_Helper_SimpleTextarea extends Zend_Dojo_View_Helper_Dijit
{
     ...
     */
    protected $_dijit  = 'dijit.forms.SimpleTextarea';
     ...
     */
    protected $_module = 'dijit.forms.SimpleTextarea';

    /**
     * dijit.forms.SimpleTextarea
     *
     * @param  string $id
     * @param  string $value
