...
class Zend_Form implements Iterator, Countable, Zend_Validate_Interface
{
     ...
     */
    const ENCTYPE_URLENCODED = 'application/x-www-forms-urlencoded';
    const ENCTYPE_MULTIPART  = 'multipart/forms-data';
    /**#@-*/
    ...
    /**
     * Custom forms-level error messages
     * @var array
     */
    protected $_errorMessages = array();

    /**
     * Are there error in the forms?
     * @var bool
     */
    protected $_errorsExist = false;

    /**
     * Has the forms been manually flagged as an error?
     * @var bool
     */
    ...
    /**
     * Whether or not forms elements are members of an array
     * @var bool
     */
     ...
     * Constructor
     *
     * Registers forms view helper as decorator
     *
     * @param mixed $options
     * @return void
     */
    ...
    /**
     * Clone forms object and all children
     *
     * @return void
     */
    ...
    /**
     * Initialize forms (used by extending classes)
     *
     * @return void
     */
    ...
    /**
     * Set forms state from options array
     *
     * @param  array $options
     * @return Zend_Form
     */
    ...
    /**
     * Set forms state from config object
     *
    ...
    /**
     * Add multiple forms attributes at once
     *
     * @param  array $attribs
     * @return Zend_Form
     */
    ...
    /**
     * Set multiple forms attributes at once
     *
    ...
    /**
     * Retrieve a single forms attribute
     *
     * @param  string $key
     * @return mixed
     */
    ...
    /**
     * Retrieve all forms attributes/metadata
     *
     * @return array
     */
    ...
    public function setMethod($method)
    {
        ...
        if (!in_array($method, $this->_methods)) {
            require_once 'Zend/Form/Exception.php';
            throw new Zend_Form_Exception(sprintf('"%s" is an invalid forms method', $method));
        }
     ...
     * method will not be attached to the forms, but will contain element
     * settings as specified in the forms object (including plugin loader
    ...
    /**
     * Set forms elements (overwrites existing elements)
     *
     * @param  array $elements
     * @return Zend_Form
     */
    ...
    /**
     * Retrieve all forms element values
     *
    ...
    /**
     * Returns only the valid values from the given forms input.
     *
    ...
    /**
     * Add multiple forms subForms/subforms at once
     *
    ...
    /**
     * Set multiple forms subForms/subforms (overwrites)
     *
     * @param  array $subForms
     * @return Zend_Form
     */
    ...
    /**
     * Retrieve a forms subForm/subform
     *
     * @param  string $name
    ...
    /**
     * Retrieve all forms subForms/subforms
     *
     * @return array
     */
    ...
    /**
     * Remove all forms subForms/subforms
     *
     * @return Zend_Form
     */
     ...
     *
     * If a referenced element does not yet exist in the forms, it is omitted.
     *
     * @param  array $elements
     * @param  string $name
     * @param  array|Zend_Config $options
    ...
    public function __toString()
    {
        try {
            ...
            $message = "Exception caught by forms: " . $e->getMessage()
                     . "\nStack Trace:\n" . $e->getTraceAsString();
    ...
    /**
     * Does this forms have its own specific translator?
     *
     * @return bool
     */
    ...
    /**
     * Overloading: access to elements, forms groups, and display groups
     *
     * @param  string $name
    ...
    public function __set($name, $value)
    {
        ...
        throw new Zend_Form_Exception('Only forms elements and groups may be overloaded; variable of type "' . $type . '" provided');
    }
    ...
    public function current()
    {
        ...
        if (isset($this->_elements[$key])) {
            ...
            require_once 'Zend/Form/Exception.php';
            throw new Zend_Form_Exception(sprintf('Corruption detected in forms; invalid key ("%s") found in internal iterator', (string) $key));
        }
    }
     ...
     *
     * @param  string $name Element/group/forms name
     * @return void
     */
