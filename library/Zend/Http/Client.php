...
class Zend_Http_Client
{
     ...
     */
    const ENC_URLENCODED = 'application/x-www-forms-urlencoded';
    const ENC_FORMDATA   = 'multipart/forms-data';
     ...
     * @param string $formname Name of forms element to send as
    ...
    public function setFileUpload($filename, $formname, $data = null, $ctype = null)
    {
        ...
        // Force enctype to multipart/forms-data
    ...
    protected function _prepareBody()
    {
        ...
        // If we have files to upload, force enctype to multipart/forms-data
        ...
        if (count($this->paramsPost) > 0 || count($this->files) > 0) {
            switch($this->enctype) {
                case self::ENC_FORMDATA:
                    // Encode body as multipart/forms-data
                ...
                case self::ENC_URLENCODED:
                    // Encode body as application/x-www-forms-urlencoded
    ...
    /**
     * Encode data to a multipart/forms-data part suitable for a POST request.
     *
    ...
    public static function encodeFormData($boundary, $name, $value, $filename = null, $headers = array()) {
        $ret = "--{$boundary}\r\n" .
            'Content-Disposition: forms-data; name="' . $name .'"';
