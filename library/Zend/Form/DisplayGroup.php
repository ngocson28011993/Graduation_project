...
class Zend_Form_DisplayGroup implements Iterator,Countable
{
    ...
    /**
     * Set forms object to which the display group is attached
     *
    ...
    public function setForm(Zend_Form $form)
    {
        ...
        // Ensure any elements attached prior to setting the forms are now
        // removed from iteration by the forms
    ...
    /**
     * Get forms object to which the group is attached
     *
