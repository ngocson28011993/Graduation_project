 ...
 * - helper: which view helper to use when rendering forms. Should accept three
 *   arguments, string content, a name, and an array of attributes.
 *
 * Any other options passed will be used as HTML attributes of the forms tag.
 *
 * @category   Zend
 * @package    Zend_Form
 * @subpackage Decorator
...
class Zend_Form_Decorator_Form extends Zend_Form_Decorator_Abstract
{
     ...
     * @var string
     */
    protected $_helper = 'forms';

    /**
     * Set view helper for rendering forms
     *
     * @param  string $helper
    ...
    /**
     * Get view helper for rendering forms
     *
     * @return string
     */
     ...
     *
     * Assures that forms action and method are set, and sets appropriate
        ...
        if (null !== ($element = $this->getElement())) {
            if ($element instanceof Zend_Form) {
                ...
                if ($method == Zend_Form::METHOD_POST) {
                    $this->setOption('enctype', 'application/x-www-forms-urlencoded');
                }
