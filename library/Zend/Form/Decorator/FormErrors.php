 ...
 *
 * Displays all forms error in one view.
 *
...
class Zend_Form_Decorator_FormErrors extends Zend_Form_Decorator_Abstract
{
    ...
    protected $_defaults = array(
        ...
        'markupListStart'         => '<ul class="forms-error">',
    );
     ...
     * in addition to custom forms messages.
     *
    ...
    /**
     * Recurse through a forms object, rendering error
     *
