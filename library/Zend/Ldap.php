...
class Zend_Ldap
{
     ...
     * ACCTNAME_FORM_USERNAME indicating the forms usernames should be canonicalized to.
     */
    protected function _getAccountCanonicalForm()
    {
         ...
         * no account canonical forms is specified, we guess based in what domain
     ...
     * @param  int    $type     The desired forms of canonicalization
     * @return string The canonicalized name in the desired forms
     * @throws Zend_Ldap_Exception
     */
    public function getCanonicalAccountName($acctname, $form = 0)
    {
        ...
        switch ($form) {
            ...
            default:
                 ...
                 */
                require_once 'Zend/Ldap/Exception.php';
                throw new Zend_Ldap_Exception(null, "Unknown canonical name forms: $form");
        }
    }
    ...
    public function bind($username = null, $password = null)
    {
        ...
        if (empty($username)) {
            ...
            /* Check to make sure the username is in DN forms.
             */
            /**
             * @see Zend_Ldap_Dn
             */
            ...
            if (!Zend_Ldap_Dn::checkDn($username)) {
                if ($this->_getBindRequiresDn()) {
                    ...
                    if ($moreCreds) {
                         ...
                         */
                        require_once 'Zend/Ldap/Exception.php';
                        throw new Zend_Ldap_Exception(null, 'Binding requires username in DN forms');
                    }
                } else {
